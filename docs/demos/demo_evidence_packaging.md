...
This page packages the completed Phase 1 through Phase 4 replay work into one
operator path and one retained evidence bundle.
...
4. records `replay-host diff` outputs for identical and perturbed comparisons
5. records `artifact_diff.py` outputs for identical and perturbed comparisons
...
claims, firmware changes, or replay-tool redesign.
