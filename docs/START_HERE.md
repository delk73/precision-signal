...
This page routes readers to the active contracts, evidence, and operational
documentation. Verification readers start with
[VERIFICATION_GUIDE.md](VERIFICATION_GUIDE.md) and follow its selected path.
Folder indexes are routing aids only.

## Active Reading Path

Start here, then follow the route that matches your task:

1. [VERIFICATION_GUIDE.md](VERIFICATION_GUIDE.md): verification path selector.
...
8. [verification/releases/index.md](verification/releases/index.md): retained
   release mechanics and historical verification landing.
