...
**Lock Status:** LOCKED
**Carry-forward note:** This contract was locked at release `1.2.1` and is carried forward unchanged for release `1.7.0`.
...
- The `v1.2.1` title label is the lock-release identifier for this contract, not a claim that release `1.7.0` changed the math contract.
