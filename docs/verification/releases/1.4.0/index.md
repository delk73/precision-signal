...
Retained release-scope note:

- [VERIFICATION_SCOPE.md](VERIFICATION_SCOPE.md): release-scoped proof boundary
...
- [make_check_workspace.txt](make_check_workspace.txt)
...
- [cargo_test_sine_bounded_correctness.txt](cargo_test_sine_bounded_correctness.txt)
- [cargo_test_triangle_control_surface.txt](cargo_test_triangle_control_surface.txt)
