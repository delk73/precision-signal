...
The current workspace version and latest retained release evidence path are
listed in [docs/RELEASE_SURFACE.md](../RELEASE_SURFACE.md). The older
hardware-backed retained release record remains explicit under
